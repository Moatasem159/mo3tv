...
class AccountRepositoryImpl implements AccountRepository{
  ...
  AccountRepositoryImpl(this._baseRepository,this._accountRemoteDataSource, this._accountLocalDataSource);
  @override
  Future<Either<Failure,Account>> getAccountDetails({required String sessionId})async{
    return _baseRepository.execute<Account>(() => _accountRemoteDataSource.getAccountDetails(sessionId));
  }
  @override
  Future<Either<Failure,AccountListEntity>> getAccountList(MediaParams params)async {
    return _baseRepository.execute<AccountListEntity>(() => _accountRemoteDataSource.getAccountList(params));
  }
  @override
