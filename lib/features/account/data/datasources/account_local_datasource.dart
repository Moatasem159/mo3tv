...
class AccountLocalDatasourceImpl implements AccountLocalDataSource{
  ...
  Future<bool> saveUser({required  accountModel}) async{
    final res=await _sharedPrefrencesConsumer.saveData(key: AppStrings.account, value: AccountModel.toJsonString(accountModel));
    return res;
  }
  @override
  Future getUser() async{
    final res=await _sharedPrefrencesConsumer.getData(key: AppStrings.account);
    if(res!=null)
      {
