...
class AccountFavMovieCubit extends Cubit<AccountFavMovieStates> {
  ...
  final GetAccountMoviesListUsecase _getFavMoviesListUsecase;
  ...
  Future<void> getAccountFavoriteMovies()async{
    ...
    Either<Failure, List> favMovies =await _getFavMoviesListUsecase.call(listType: 'favorite',mediaType: "movies");
    favMovies.fold((l){
