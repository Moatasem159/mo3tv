...
class TvShowRepositoryImpl implements TvRepository{
  ...
  const TvShowRepositoryImpl(this._tvShowRemoteDataSource,this._baseRepository);
  @override
  Future<Either<Failure, TvShow>> getTvShowDetails(MediaParams params)async {
    return _baseRepository.execute<TvShow>(() => _tvShowRemoteDataSource.getTvShowDetails(params));
  }
  @override
  Future<Either<Failure, TvShowSeason>> getTvShowSeasonDetails(MediaParams params)async {
    return _baseRepository.execute<TvShowSeason>(() => _tvShowRemoteDataSource.getTvShowSeasonDetails(params));
  }
