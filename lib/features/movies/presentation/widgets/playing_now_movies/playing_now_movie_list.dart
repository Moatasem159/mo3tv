...
class PlayingNowMoviesLoadingCarousal extends StatelessWidget {
  const PlayingNowMoviesLoadingCarousal({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CarouselSlider(
      ...
      items:const [PlayingNowMovieLoadingCard()],
    );
  }
}