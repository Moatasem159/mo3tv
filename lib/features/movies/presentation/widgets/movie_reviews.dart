  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieCubit, MovieStates>(
      builder: (context, state) {
        ...
        if (state is GetMovieReviewsLoadingState ||
            cubit.movieReviews == null) {
          return const ReviewsLoadingList();
        }
        if (state is GetMovieReviewsSuccessState &&
            cubit.movieReviews != null && cubit.movieReviews!.isEmpty) {
          return const ReviewEmptyWidget(msg: "No reviews on this movie");
        }
