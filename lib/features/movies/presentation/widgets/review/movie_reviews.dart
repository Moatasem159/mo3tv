...
import 'package:mo3tv/features/movies/presentation/widgets/review/movie_review_list.dart';
import 'package:mo3tv/features/movies/presentation/widgets/review/movie_reviews_loading_list.dart';
    ...
    return BlocConsumer<MovieCubit, MovieStates>(
      ...
      builder: (context, state) {
        ...
        if (cubit.movieReviews != null && cubit.movieReviews!.isNotEmpty) {
          return MovieReviewsList(reviews: cubit.movieReviews!,);
        }
