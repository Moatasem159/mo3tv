...
class _TvShowDetailsScreenState extends State<TvShowDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context) => TvShowBottomNavCubit()..tvId = widget.tvShow.id!),
      ...
      child: Builder(builder: (context) {
        if (!TvCubit.get(context).isSuccess()) {
          TvCubit.get(context).getTvShowDetailsData(
              tvShowId: widget.tvShow.id!,
              lang: AppLocalizations.of(context)!.getLang());
        }
                ...
                child: SafeArea(
                  child: Scaffold(
                    ...
                    body: NestedScrollView(
                      controller:
                          TvShowBottomNavCubit.get(context).nestedController,
                          ...
                          if (cubit.isGallery)
                            SliverOverlapAbsorber(
                                ...
                                sliver: GalleryTabBar(
                                  onTap: (value) {
                                    GalleryNavigatorCubit.get(context)
                                        .gallery(value);
                                  },
                                ))
                        ];
