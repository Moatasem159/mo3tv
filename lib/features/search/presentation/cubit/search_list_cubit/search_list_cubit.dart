...
class SearchListCubit extends Cubit<SearchListStates> {
  ...
  Future<void> saveSearch({required Search search})async{
    ...
    Either<Failure,bool> response = await _saveSearchUsecase.call(search: search);
  ...
  Future<void> getSearchList() async {
    ...
    Either<Failure, List<Search>> response = await _getSearchListUsecase.call();
  ...
  Future<void> clearSearch()async{
    ...
    Either<Failure,bool> response = await _clearSearchListUsecase.call();
  ...
  Future<void> clearOneSearch({required Search search})async{
    emit(ClearSearchLoadingState());
    Either<Failure,bool> response = await _clearOneSearchListUsecase.call(search: search);
    emit(response.fold((l)=>ClearSearchErrorState(), (r){
